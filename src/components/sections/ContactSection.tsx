  ...
  return (
    <SectionWrapper id="contact" className="bg-card">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8">
        <h2 className="font-headline text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-widest uppercase">GET IN TOUCH...</h2>
        
        <div className="space-y-4 font-code text-sm md:text-base text-foreground/80 leading-relaxed max-w-2xl">
            <p>
        ...
        <a href="mailto:dreambig@dreamwithvision.com" className="font-headline text-xl md:text-2xl text-primary hover:underline mt-4">
            dreambig@dreamwithvision.com
        </a>
      </div>
      <footer className="mt-24 border-t border-border/20 pt-8 w-full max-w-7xl mx-auto">
        <p className="text-muted-foreground text-xs md:text-sm">&copy; {year} Dream With Vision. All Rights Reserved.</p>
      </footer>
    </SectionWrapper>
  );
}
