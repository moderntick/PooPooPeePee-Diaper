  ...
  return (
    <SectionWrapper id="about">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-8">
        <h2 className="font-headline text-2xl sm:text-2xl md:text-3xl font-bold text-primary uppercase">Let's dream together...</h2>
        
        <div className="space-y-2">
          <p className="font-body text-lg sm:text-lg md:text-2xl text-foreground/80 leading-relaxed">
        ...
        <div className="w-full mt-4">
            <p className="font-body text-lg sm:text-lg md:text-2xl text-foreground/80 leading-relaxed max-w-2xl mx-auto italic">
