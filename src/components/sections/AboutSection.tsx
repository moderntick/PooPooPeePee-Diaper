  ...
  return (
    <SectionWrapper id="about">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-8">
        <h2 className="font-headline text-4xl md:text-5xl font-bold text-primary uppercase">About Dream with Vision</h2>
        ...
        <div className="w-full mt-4">
          <h3 className="font-headline text-3xl font-bold text-primary mb-6 uppercase">What We Do</h3>
        ...
        <div className="w-full mt-8">
            <h3 className="font-headline text-3xl font-bold text-primary mb-4 uppercase">Our Philosophy</h3>
            <p className="font-body text-base md:text-lg text-foreground/80 leading-relaxed max-w-2xl mx-auto italic">
