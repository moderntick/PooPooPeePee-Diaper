  ...
  return (
    <SectionWrapper id="about">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-8">
        <h2 className="font-headline text-base md:text-lg font-bold text-primary uppercase">hello, nice to meet you</h2>
        ...
        <div className="w-full mt-4">
            <p className="font-body text-xs sm:text-sm text-foreground/80 leading-relaxed max-w-2xl mx-auto italic">
